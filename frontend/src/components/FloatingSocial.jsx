...
export default function FloatingSocial({ settings }) {
  ...
  const items = [
    ...
    { id: 'instagram', label: 'Instagram', icon: <InstagramIcon />, href: s.instagram || 'https://www.instagram.com/genz_teck', color: '#E1306C', external: true },
    { id: 'facebook', label: 'Facebook', icon: <FacebookIcon />, href: s.facebook || 'https://www.facebook.com/share/1LpRPBaGaP/', color: '#1877F2', external: true },
    { id: 'youtube', label: 'YouTube', icon: <YoutubeIcon />, href: s.youtube || 'https://youtube.com/@genzteck', color: '#FF0000', external: true },
    { id: 'linkedin', label: 'LinkedIn', icon: <LinkedinIcon />, href: s.linkedin || 'https://www.linkedin.com/company/genztecknology/', color: '#0A66C2', external: true },
    { id: 'phone', label: 'Call Us', icon: <Phone size={20} />, href: `tel:${(s.phone || '+918769592668').replace(/\s/g, '')}`, color: '#00D4FF', external: false },
    { id: 'email', label: 'Email', icon: <Mail size={20} />, href: `mailto:${s.email || 'info.genzteck@gmail.com'}`, color: '#7B2FBE', external: false },
  ];
