...
const defaultTestimonials = [
  ...
  { _id: '2', name: 'Priya Patel', businessName: 'Axora Homes', rating: 5, type: 'Web Development', reviewText: 'The real estate website they built is exactly what we envisioned. Clean, professional, and it converts really well. Our qualified leads are up 200% since launch. Best investment we made this year.' },
  { _id: '3', name: 'Chef Meera Jain', businessName: 'Zaira Restaurant', rating: 5, type: 'Restaurant System', reviewText: 'Our QR menu and online ordering system has been a total game changer. Customers love the experience, and our online revenue is up 40% since launch. GenzTeck delivered beyond expectations!' },
